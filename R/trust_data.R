...
academies.trust.data <- function(gias_date, cut_off_date, urn_link_type = "ofsted"){
  ...
  trust_history_infer_join_date <- dplyr::mutate(trust_history,
                                                 date_joined_group = dplyr::if_else(is.na(.data$date_joined_group), .data$establishment_open_date, .data$date_joined_group))
  ...
  trust_list <- dplyr::filter(trust_list,
                              .data$n == 1 | (.data$n > 1 & .data$group_status == "Open"))

  trust_list <- dplyr::select(trust_list, -.data$n)
  ...
  trust_history_correct_dates <- dplyr::mutate(trust_history_remove_wrong_trust,
                                               date_joined_group = dplyr::case_when(.data$current_urn == "136789" & .data$group_id == "TR01513" ~ as.Date("2015-10-01"),
                                                                                    ...
                                                                                    .data$current_urn == "150811" & .data$group_id == "TR00552" ~ as.Date("2015-07-01"),
                                                                                    .data$current_urn == "150811" & .data$group_id == "TR02253" ~ as.Date("2015-11-01"),
                                               ...
                                               date_left_group = dplyr::case_when(.data$current_urn == "140533" & .data$group_id == "TR00411" ~ as.Date("2016-08-31"),
                                                                                  ...
                                                                                  .data$current_urn == "150811" & .data$group_id == "TR00552" ~ as.Date("2015-10-31"),
